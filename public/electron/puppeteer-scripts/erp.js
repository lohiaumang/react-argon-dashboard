module.exports = function erp(page,{ data, modelData, dealerData },mainWindow) {
  const { typeText } = require("../puppeteer-scripts/halper");
  ...
  async function automate() {
    ...
    // fill data select
    await click(page,'table > tbody > tr > .siebui-bullet-item > #s_3_2_18_0_span > .siebui-anchor-readonly > a[rowid="5"]');
    ...
    await typeText(page, 'table > tbody > tr > td > .mceField > input[name="s_1_2_50_0"]','Individual')
    await typeText(page, 'table > tbody > tr > td > .mceField > input[name="s_1_2_52_0"]','Individual')
    await typeText(page, 'table > tbody > tr > td > .mceField > input[name="s_1_2_59_0"]','Cash')
