module.exports = async function (page, data, mainWindow) {
  ...
  //   }
     ...
     await page.type("#ctrlCustomerAddress_TxtCustName", `${data.customerInfo.firstName} ${data.customerInfo.lastName}`);
     await page.type("#ctrlCustomerAddress_TxtCustAddressLine1", data.customerInfo.currLineOne);
     await page.type("#ctrlCustomerAddress_TxtCustAddressLine2", data.customerInfo.currLineTwo);
     await page.type("#ctrlCustomerAddress_TxtCustPincode", data.customerInfo.currPostal);
     ...
     await page.type("#ctrlCustomerAddress_TxtCustEmail", data.customerInfo.email);//todo
     await page.type("#ctrlCustomerAddress_TxtCustMobile", data.customerInfo.phoneNo);
     await waitForRandom();
