module.exports = function vahan(page, data, mainWindow) {
  ...
  console.log(data.vehicleInfo.frameNumber, "step 1");
  ...
  const automate = async function () {
    try {
      ...
      await waitForRandom();
      console.log(data.vehicleInfo.frameNumber);
      await page.type("#chasi_no_new_entry", data.vehicleInfo.frameNumber);
      console.log(data.vehicleInfo.frameNumber, "frameNumber");
      await waitForRandom();
      console.log(data.vehicleInfo.engineNumber);
      await page.type("#eng_no_new_entry", data.vehicleInfo.engineNumber);
